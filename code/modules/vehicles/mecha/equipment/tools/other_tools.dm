...
/obj/item/mecha_parts/mecha_equipment/teleporter
	...
	desc = "Модуль экзокостюма, позволяющий телепортироваться в любую точку в поле зрения."
...
/obj/item/mecha_parts/mecha_equipment/wormhole_generator
	...
	desc = "Модуль экзокостюма, позволяющий создавать малые квазистабильные червоточины."
...
/obj/item/mecha_parts/mecha_equipment/gravcatapult
	...
	desc = "Установленный на экзокостюм гравитационный катапульт."
	icon_state = "mecha_teleport"
	equip_cooldown = 10
	energy_drain = 100
...
/obj/item/mecha_parts/mecha_equipment/anticcw_armor_booster //what is that noise? A BAWWW from TK mutants.
	...
	desc = "Усиливает броню экзокостюма против вооружённых атак ближнего боя. Требует энергии для работы."
...
/obj/item/mecha_parts/mecha_equipment/antiproj_armor_booster
	...
	desc = "Усиливает броню экзокостюма против дальнобойных атак. Полностью блокирует выстрелы тазеров. Требует энергии для работы."
...
/obj/item/mecha_parts/mecha_equipment/repair_droid
	...
	desc = "Автономный дрон, автоматически чинящий повреждения экзокостюма. Сканирует на наличие повреждений и устраняет их. Может исправить практически все виды внешних и внутренних повреждений."
...
/obj/item/mecha_parts/mecha_equipment/tesla_energy_relay
	...
	desc = "Модуль экзокостюма, беспроводным образом подзаряжающий батарею от любого доступного источника питания в области. КПД довольно низок."
	icon_state = "tesla"
	energy_drain = 0
	range = 0
	var/coeff = 100
...
/obj/item/mecha_parts/mecha_equipment/generator
	...
	desc = "Модуль экзокостюма, генерирующий энергию сжиганием твёрдой плазмы в качестве топлива. Загрязняет окружающую среду."
	icon_state = "tesla"
	range = MECHA_MELEE
	var/coeff = 100
...
/obj/item/mecha_parts/mecha_equipment/generator/nuclear
	...
	desc = "Модуль экзокостюма, генерирующий энергию с использованием урана в качестве топлива. Загрязняет окружающую среду."
	icon_state = "tesla"
	max_fuel = 50000
...
/obj/item/mecha_parts/mecha_equipment/thrusters
	...
	desc = "Универсальный набор двигателей неизвестного происхождения. Использует непонятные методы для перемещения экзокостюма, кажется, бесплатно."
...
/obj/item/mecha_parts/mecha_equipment/thrusters/gas
	...
	desc = "Набор двигателей, позволяющих перемещать экзокостюм в невесомости за счёт расхода газа из внутреннего баллона жизнеобеспечения."
...
/obj/item/mecha_parts/mecha_equipment/thrusters/ion //for mechs with built-in thrusters, should never really exist un-attached to a mech
	...
	desc = "Набор ионных двигателей, позволяющих перемещать экзокостюм в невесомости."
