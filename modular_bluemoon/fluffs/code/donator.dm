...
/datum/gear/donator/bm/monolith_patch
	...
	ckeywhitelist = list("irfish", "devildeadspace", "mikolaostavkin", "allazarius", "definitelynotnesuby", "hazzi", "dimofon", "mihana964")
...
/datum/gear/donator/bm/hateredsoul_dogtag
	...
	ckeywhitelist = list("hateredsoul", "ggishka", "arion1234", "swgitty", "sw00ty", "sierraiv", "ordinarylife", "milidead", "blatoff", "angelnedemon", "foxrtotlimda")
...
/datum/gear/donator/bm/paws_patch
	...
	ckeywhitelist = list("devildeadspace", "mikolaostavkin", "cupteazee", "dimofon", "dimakr", "definitelynotnesuby", "scramblescream", "tblkba", "hellsinggc", "aurses", "mihana964")
...
/datum/gear/donator/bm/h_thin_tshirt
	...
	path = /obj/item/clothing/under/donator/bm/h_thin_tshirt
	ckeywhitelist = list("hateredsoul")

/datum/gear/donator/bm/h_slim_tshirt
	name = "Thin T-shirt"
	slot = ITEM_SLOT_UNDERWEAR
	path = /obj/item/clothing/under/donator/bm/h_slim_tshirt
	ckeywhitelist = list("hateredsoul")

/datum/gear/donator/bm/h_eslim_tshirt
	name = "EXTRA Thin T-shirt"
	slot = ITEM_SLOT_UNDERWEAR
	path = /obj/item/clothing/under/donator/bm/h_eslim_tshirt
	ckeywhitelist = list("hateredsoul")
